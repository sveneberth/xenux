...
if(!empty($_POST)) {
	...
	if(!empty($filename) and !empty($fullname)) {
		...
		if($var->anzahl >= 1) {
			echo '<p style="color:red;">Es existiert bereits eine Seite mit dem Kurznamen <i>'.$filename.'</i> Duplikate sind nicht erlaubt!</p>';
		} else{
...
<form action="" method="post">
	...
	<input type="text" placeholder="Seitenkurzname" name="filename" maxlength="15" value="<?php echo @$filename; ?>"><br /><br />
