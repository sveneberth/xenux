...
$id = mysql_real_escape_string($_GET['id']);
	if(isset($_POST['sub2'])) {
		...
		<form action="" method="post">
			...
			<input type="date" name="dat" size="70" value="<?php echo $dat; ?>" /><br /><br />
			<span <?php if (empty($time) and $_SERVER['REQUEST_METHOD'] == "POST"){echo 'style="color:#cc0000;"';} ?>>Zeit:</span><br />
			<input type="time" name="time" size="70" value="<?php echo $time; ?>" /><br /><br />
...
<br />
<table id="table1">
<tr><th>Name</th><th>Text</th><th>Datum</th><th></th><th></th></tr>
<?php
