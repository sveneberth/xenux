...
<div class="grid-row">
	<section class="box-shadow grid-col">
		<div class="actions">
			...
			<button class="upload" data-title="<?= __('upload') ?>"></button>
			<button class="create_folder" data-title="<?= __('create folder') ?>"></button>
			<button class="remove" data-title="<?= __('remove') ?>"></button>
			<button class="move" data-title="<?= __('move') ?>"></button>
			<button class="rename" data-title="<?= __('rename') ?>"></button>
		</div>
